export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <title>Alchemy United - Premium EV Charging Network</title>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/early-access">
              <button className="px-8 py-4 bg-gradient-to-r from-gold to-yellow-600 text-black font-medium rounded-lg hover:from-yellow-400 hover:to-gold transition-all duration-300 transform hover:scale-105">
                JOIN THE NETWORK
              </button>
            </a>
      ...
      <section className="py-16 bg-gray-900/50">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/early-access">
              <button className="px-12 py-4 bg-gradient-to-r from-gold to-yellow-600 text-black font-bold rounded-full text-lg hover:from-yellow-400 hover:to-gold transition-all duration-300 transform hover:scale-105">
                Get Early Access
              </button>
            </a>
            <a href="/host">
              <button className="px-12 py-4 border-2 border-gold text-gold font-bold rounded-full text-lg hover:bg-gold hover:text-black transition-all duration-300">
                Become a Host
              </button>
            </a>
          </div>
      ...
      <footer className="py-12 border-t border-gray-800">
        <div className="max-w-6xl mx-auto text-center px-4">
          ...
          <div className="mt-4 flex justify-center space-x-6">
            <a href="/dashboard" className="text-gray-500 hover:text-gold transition-colors">Dashboard</a>
            <a href="/early-access" className="text-gray-500 hover:text-gold transition-colors">Early Access</a>
            <a href="/host" className="text-gray-500 hover:text-gold transition-colors">Host Program</a>
          </div>
        </div>
      </footer>
    </div>
