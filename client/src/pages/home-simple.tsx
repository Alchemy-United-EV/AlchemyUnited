  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-gold">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 border border-gray-800 rounded-lg bg-gray-900/30">
              <div className="text-4xl text-gold mb-4">⚡</div>
              <h3 className="text-xl font-medium mb-4">Ultra-Fast Charging</h3>
              <p className="text-gray-400">Revolutionary charging speeds that redefine convenience</p>
            </div>
            
            <div className="text-center p-8 border border-gray-800 rounded-lg bg-gray-900/30">
              <div className="text-4xl text-gold mb-4">🌐</div>
              <h3 className="text-xl font-medium mb-4">Network Membership</h3>
              <p className="text-gray-400">Exclusive access to premium charging locations</p>
            </div>
